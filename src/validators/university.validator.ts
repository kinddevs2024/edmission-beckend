...
export const updateProfileSchema = z.object({
  body: z.object({
    ...
    coverImageUrl: optionalLogoUrlSchema,
    ...
    /** Minimum IELTS band; when set with minLanguageLevel / IELTS text, upload required for interest */
    ieltsMinBand: z.number().min(0).max(9).nullable().optional(),
    gpaMinMode: z.enum(['scale', 'percent']).nullable().optional(),
    gpaMinValue: z.number().min(0).nullable().optional(),
