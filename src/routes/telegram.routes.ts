...
router.use(requireRole('student', 'university', 'university_multi_manager', 'multi_university_admin', 'school_counsellor', 'admin', 'student_admin', 'counsellor_coordinator', 'manager'));
